            ...
            {leaderboard.slice(0, 3).map((userItem, idx) => (
              ...
              >
                ...
                <div className={`bg-white/10 backdrop-blur-xl rounded-2xl p-4 sm:p-6 border border-white/20 shadow-2xl w-full max-w-[200px] ${
                  ...
                  {/* Username */}
                  <h3 className="font-bold text-center mb-2 text-sm sm:text-base">{userItem.username}</h3>
                  ...
                  <div className="text-center mb-3">
                    <div className="text-2xl sm:text-3xl font-bold text-cyan-300">{userItem.points}</div>
                ...
                {leaderboard.map((userItem, idx) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6 text-right">
                      <div className="font-bold text-cyan-300">{userItem.total_points}</div>
                    </td>
                  </tr>
                ))}
              </tbody>
